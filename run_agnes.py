...
argparser.add_argument('--feature-dim', type=int, default=128)
argparser.add_argument('--buffer-size', type=int, default=16384)
argparser.add_argument('--dataset', type=str, default='Ogbn')
argparser.add_argument('--dataset_path', type=str, default='/home/nvme1/ogbn1M_64bit/')
...
def execute(i, pbar, total_loss, total_correct, last, mode='train'):
    ...
    for idx in range(num_iter):
        ...
        if idx == 0:
            ...
            # Gather
            batch_inputs = gather_sagnn(features, n_id, num_features, idx, num_workers) 
